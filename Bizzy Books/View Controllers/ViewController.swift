 ...
 */
    ...
    @IBAction func editAccountUpdatePressed(_ sender: UIButton) {
        ...
        DispatchQueue.main.async {
            ...
            accountMultipathDict = ["accounts/\(self.accountKeyPlaceholder)/name": self.accountNamePlaceholder.encryptIt(), "accounts/\(self.accountKeyPlaceholder)/startingBal": self.accountStartingBalance.toString().encryptIt(), "accounts/\(self.accountKeyPlaceholder)/phoneNumber": self.phoneNumberPlaceholder.encryptIt(), "accounts/\(self.accountKeyPlaceholder)/email": self.emailPlaceholder.encryptIt(), "accounts/\(self.accountKeyPlaceholder)/street": self.streetPlaceholder.encryptIt(), "accounts/\(self.accountKeyPlaceholder)/city": self.cityPlaceholder.encryptIt(), "accounts/\(self.accountKeyPlaceholder)/state": self.statePlaceholder.encryptIt(), "accounts/\(self.accountKeyPlaceholder)/accountTypeId": self.accountTypeId]
