...
//            }
    ...
    func saveUniversal() {
        ...
        default: //The UpdateUniversal case, where MIPnumber represents item number in array
            ...
            DispatchQueue.main.async {
                self.universalsRef.child(self.addUniversalKeyString).updateChildValues(["projectItemName": self.projectPlaceholder.encryptIt(), "projectItemKey": self.projectPlaceholderKeyString, "odometerReading": TheAmtSingleton.shared.theOdo, "howMany": String(TheAmtSingleton.shared.howMany), "notes": notes, "whoName": self.whoPlaceholder, "whoKey": self.whoPlaceholderKeyString, "fuelTypeName": self.fuelTypePlaceholder, "fuelTypeId": self.fuelTypePlaceholderId, "what": String(TheAmtSingleton.shared.theAmt), "whomName": self.whomPlaceholder, "whomKey": self.whomPlaceholderKeyString, "taxReasonName": self.whatTaxReasonPlaceholder, "taxReasonId": self.whatTaxReasonPlaceholderId, "vehicleName": self.vehiclePlaceholder, "vehicleKey": self.vehiclePlaceholderKeyString, "workersCompName": self.workersCompPlaceholder, "workersCompId": self.workersCompPlaceholderId, "advertisingMeansName": self.advertisingMeansPlaceholder.encryptIt(), "advertisingMeansId": self.advertisingMeansPlaceholderId, "personalReasonName": self.whatPersonalReasonPlaceholder, "personalReasonId": self.whatPersonalReasonPlaceholderId, "percentBusiness": self.thePercent, "accountOneName": self.yourAccountPlaceholder, "accountOneKey": self.yourAccountPlaceholderKeyString, "accountOneType": self.accountTypePlaceholderId, "accountTwoName": self.yourSecondaryAccountPlaceholder, "accountTwoKey": self.yourSecondaryAccountPlaceholderKeyString, "accountTwoType": self.secondaryAccountTypePlaceholderId, "picNumber": self.picNumber, "picUrl": urlString, "picAspectRatio": intifiedAspectRatio, "useTax": self.thereIsUseTax, "projectPicTypeName": self.projectMediaTypePlaceholder, "projectPicTypeId": self.projectMediaTypePlaceholderId])
                TheAmtSingleton.shared.theAmt = 0
                TheAmtSingleton.shared.howMany = 0
                TheAmtSingleton.shared.theOdo = 0
            }
